...
- Fixture tests: uv run pytest tests/test_aurora_fixture.py -v completed with 9 passed.
- Acceptance test: uv run pytest tests/test_acceptance_project_promise.py -v produced the expected failure only with ReasoningPipelineNotImplementedError.
